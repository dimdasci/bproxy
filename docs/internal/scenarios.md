...
# bproxy scroll -s p7k2qm --selector 'main#workspace' --by viewport --direction down
...
- When the extension performs a scroll, it uses jittered DOM polling to detect stabilization. No listener install. No fingerprint.
